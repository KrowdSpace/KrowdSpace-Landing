                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 shadow user-modal">
                        <div class="text-left user-title">
                            <p class="sign-in">About Krowdspace</p>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <ul class="timeline">
                                    ...
                                    <li class="timeline-inverted">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="text-left user-title">
                                                <p class="sign-in-small"><strong>January 2017</strong></p>
                                                <p class="sign-in-small"><strong>Building our Platform</strong></p>
                                                <div class="text-justify">
                                    ...
                                    <li class="timeline">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="text-right user-title">
                                                <p class="sign-in-small"><strong>March 2017</strong></p>
                                                <p class="sign-in-small"><strong>Krowdspace Launch</strong></p>
                                                <div class="text-justify">
                                    ...
                                    <li class="timeline-inverted">
                                        ...
                                        <div class="timeline-panel">
                                            <div class="text-left user-title">
                                                <p class="sign-in-small"><strong>Krowdspace</strong></p>
                                                <div class="text-justify">
