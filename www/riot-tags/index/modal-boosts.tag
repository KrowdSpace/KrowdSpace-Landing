                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-10 col-sm-offset-1 shadow user-modal">
                            <div class="row">
                                <div class="text-left col-sm-6 modal-container">
                                    <p class="modal-heading">Single Boosts And Descriptions</p>
                                </div>
                                <div class="text-right col-sm-6 hidden-xs">
                                    <a href="/?error=1" data-toggle="modal" class="btn btn-xl boost-purchase">Make a Purchase</a>
                                </div>
                            </div>
                            ...
                            <div class="row text-justify boost-padding">
                                <div class="col-md-4">
