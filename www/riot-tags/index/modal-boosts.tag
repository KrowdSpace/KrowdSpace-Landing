        ...
        <div class="modal-dialog">
            <div class="modal-content alternate-background">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="text-left col-sm-6 user-title">
                            <p class="sign-in">Single Boosts And Descriptions</p>
                        </div>
                        <div class="text-right col-sm-6 hidden-xs" style="padding-top:7px">
                            <a href="/?error=1" data-toggle="modal" class="btn btn-xl btn-project-wide" style="width:250px;">Make a Purchase</a>
                        </div>
                    </div>
                        ...
                        <div class="row text-justify" style="padding-top:25px;">
                            ...
                            <p style="margin:0px;">Your crowdfunding project will be listed on the main search page of our explore area for 30 days or the duration of your project, whichever is less. It will have priority filtering and a "Featured" banner in the corner.</p>
                            </div>
                            </div>
                        </div>
                        <div class="row text-justify" style="padding-top:30px;">
                            <div class="col-md-4">
                            <div style="padding:15px; height:100%;">
                        ...
                        <div class="row text-justify" style="padding-top:30px;">
                            ...
                            <p style="margin:0px;">Most companies that provide media lists give you thousands of names and no direction. At Krowdspace our media list consists of verified contacts from the largest companies out there. We provide up to 10 contacts from every company and a list of places to submit your crowdfunding video.</p>
                            </div>
                            </div>
                            <div class="col-md-4">
                            <div style=" padding:15px; height:100%;">
                            ...
                            <p class="text-center">Free</p>
                            <p style="margin:0px;">Check out our Press Release Guide and use our format to write a winning Press Release you can send out to our media list. Take our free example and turn it into your own. Get the publicity you need for your project.</p>
                            </div>
                            </div>
                        </div>
                    </div>
