<modal-privacy-policy>
    <div class="krowdspace-modal modal fade" id="modal-privacy-policy" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-content alternate-background">
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1 shadow text-left user-modal">
                        ...
                        <br>
                        <p><span class="sign-in-small"><strong>Payment:</strong></span>
                        ...
                        <p class="sign-in privacy-title">SECTION 5 - THIRD-PARTY SERVICES</p>
                        ...
                        <br>
                        <p><span class="sign-in-small"><strong>Links:</strong></span>
                            When you click on links on our store, they may direct you away from our site. We are not responsible for the privacy practices of other sites and encourage you to read their privacy statements.
                        </p>
                        <p class="sign-in privacy-title">SECTION 6 - SECURITY</p>
                        ...
                        <p class="sign-in privacy-title">SECTION 7 - COOKIES</p>
                        ...
                        <ul class="text-left quicklinks" style="font-size:15px; line-height:1.5;">
                            ...
                            <li>cart, unique token, persistent for 2 weeks, Stores information about the contents of your cart.
                        ...
                        <p class="sign-in privacy-title">SECTION 8 - AGE OF CONSENT</p>
                        <p>By using this site, you represent that you are at least the age of majority in your state or province of residence, or that you are the age of majority in your state or province of residence and you have given us your consent to allow any of your minor dependents to use this site.</p>
                        <p class="sign-in privacy-title">SECTION 9 - CHANGES TO THIS PRIVACY POLICY</p>
                        <p>We reserve the right to modify this privacy policy at any time, so please review it frequently. Changes and clarifications will take effect immediately upon their posting on the website. If we make material changes to this policy, we will notify you here that it has been updated, so that you are aware of what information we collect, how we use it, and under what circumstances, if any, we use and/or disclose it. If our store is acquired or merged with another company, your information may be transferred to the new owners so that we may continue to sell products to you.
                        </p>
                        <p class="sign-in privacy-title">QUESTIONS AND CONTACT INFORMATION</p>
                        <p>If you would like to: access, correct, amend or delete any personal information we have about you, register a complaint, or simply want more information contact our Privacy Compliance Officer by email at mason@krowdspace.com or by mail at</p>
                        <br>
                        <p>Krowdspace LLC<br>
