        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    ...
                    <br>
                    <p class="text-left text-justify">In order to have your project published on Krowdspace, you must offer an exclusive reward for backers who support you through our community. You can view examples and more information about <a href="#modal-rewards" data-toggle="modal" class="modal-link">project rewards here</a>. Krowdspace tracks each backer that accesses your project through our platform and notes their Kickstarter or Indiegogo pledge on your Krowdspace dashboard. After your project is funded, you have a convenient list of Krowdspace backers to send your exclusive rewards to.</p>
                </div>
                <div class="col-md-4 text-center">
                    <img src="/img/content/backer-icon.png" class="img-responsive img-icon" alt="Gain Backers Icon">
                    <p><strong>Gather More Backers</strong></p>
                    <br>
                    <p class="text-left text-justify">We have combined projects from the top crowdfunding sites so that you can obtain a larger audience for your campaign. Supporters that might not usually use the funding platform you’ve chosen can now discover your project and get on board. When it comes to fundraising, every advantage counts. <a href="#modal-error" data-toggle="modal" class="modal-link">Submit your project</a> today and gain access to our <a href="#modal-boost" data-toggle="modal" class="modal-link">project boosts</a> which include detailed metrics and easy to follow tips for running a successful campaign. </p>
                </div>
            </div>
        </div>
    </section>
